...
impl MType {
    ...
    fn from_u16(c: &u16) -> MType {
        match c {
            ...
            0x1780..=0x1782 | 0x1784..=0x1787 | 0x1789..=0x178C | 0x178E..=0x1793 | 0x1795..=0x1798 | 0x179B..=0x179D | 0x17A0 | 0x17A2 => MType::Cs1,
            // Consonant - SubscriptType2 (U+179A, U+1783, U+1788, U+178D, U+1794, U+1799, U+179E-U+179F, U+17A1)
            0x179A | 0x1783 | 0x1788 | 0x178D | 0x1794 | 0x1799 | 0x179E..=0x179F | 0x17A1 => MType::Cs2,
